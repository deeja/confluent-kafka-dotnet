...
namespace Confluent.Kafka
{
    ...
    public interface IProducerBuilder<TKey, TValue>
    {
        ...
        ///     <paramref name="topic" />.
        /// </summary>
        IProducerBuilder<TKey, TValue> SetPartitioner(string topic, PartitionerDelegate partitioner);
        ...
        /// </summary>
        IProducerBuilder<TKey, TValue> SetDefaultPartitioner(PartitionerDelegate partitioner);
        ...
        /// </param>
        IProducerBuilder<TKey, TValue> SetOAuthBearerTokenRefreshHandler(Action<IProducer<TKey, TValue>, string> oAuthBearerTokenRefreshHandler);
        ...
        /// </remarks>
        IProducerBuilder<TKey, TValue> SetKeySerializer(ISerializer<TKey> serializer);
        ...
        ///     Produce or ProduceAsync.
        /// </remarks>
        IProducerBuilder<TKey, TValue> SetKeySerializer(IAsyncSerializer<TKey> serializer);
        ...
        ///     Produce or ProduceAsync.
        /// </remarks>
        IProducerBuilder<TKey, TValue> SetValueSerializer(ISerializer<TValue> serializer);
        ...
        ///     Produce or ProduceAsync.
        /// </remarks>
        IProducerBuilder<TKey, TValue> SetValueSerializer(IAsyncSerializer<TValue> serializer);
