...
namespace Confluent.Kafka
{
    ...
    public interface IConsumerBuilder<TKey, TValue>
    {
        ...
        ///     ignored.
        /// </remarks>
        IConsumerBuilder<TKey, TValue> SetErrorHandler(
        ...
        ///     silently ignored.
        /// </remarks>
        IConsumerBuilder<TKey, TValue> SetLogHandler(
        ...
        /// </param>
        IConsumerBuilder<TKey, TValue> SetOAuthBearerTokenRefreshHandler(Action<IConsumer<TKey, TValue>, string> oAuthBearerTokenRefreshHandler);
        ...
        ///     Consume.
        /// </remarks>
        IConsumerBuilder<TKey, TValue> SetKeyDeserializer(IDeserializer<TKey> deserializer);
        ...
        ///     Consume.
        /// </remarks>
        IConsumerBuilder<TKey, TValue> SetValueDeserializer(IDeserializer<TValue> deserializer);
        ...
        ///     initiating call to Consume.
        /// </remarks>
        IConsumerBuilder<TKey, TValue> SetPartitionsLostHandler(
        ...
        /// </remarks>
        IConsumerBuilder<TKey, TValue> SetOffsetsCommittedHandler(Action<IConsumer<TKey, TValue>, CommittedOffsets> offsetsCommittedHandler);
